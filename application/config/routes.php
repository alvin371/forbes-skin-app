...
$route['api/hrms/files/leaves/(.+)'] = 'Api_hrms/uploaded_file/leaves';
$route['api/hrms/files/overtime/(.+)'] = 'Api_hrms/uploaded_file/overtime';
$route['api/hrms/files/attendance/(.+)'] = 'Api_hrms/uploaded_file/attendance';
$route['writable/uploads/leaves/(.+)'] = 'Api_hrms/uploaded_file/leaves';
$route['writable/uploads/overtime/(.+)'] = 'Api_hrms/uploaded_file/overtime';
$route['writable/uploads/attendance/(.+)'] = 'Api_hrms/uploaded_file/attendance';
