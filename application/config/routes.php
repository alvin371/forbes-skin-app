...
$route['api/hrms/files/leaves/(.+)'] = 'Api_hrms/uploaded_file/leaves/$1';
$route['api/hrms/files/overtime/(.+)'] = 'Api_hrms/uploaded_file/overtime/$1';
$route['writable/uploads/leaves/(.+)'] = 'Api_hrms/uploaded_file/leaves/$1';
$route['writable/uploads/overtime/(.+)'] = 'Api_hrms/uploaded_file/overtime/$1';
