...
$route['admin/approval-routes/(:any)/versions'] = 'admin/ApprovalRoutesController/versions/$1';
$route['admin/approval-routes/detail/(:num)'] = 'admin/ApprovalRoutesController/detail/$1';
$route['admin/approval-routes/preview/(:num)'] = 'admin/ApprovalRoutesController/preview/$1';
...
$route['admin/approval-routes/(:num)/clone'] = 'admin/ApprovalRoutesController/clone_route/$1';
$route['admin/overtime-approval-routes'] = 'admin/ApprovalRoutesController/overtime_redirect';
...
$route['healthz'] = 'HealthController/index';
...
$route['api/hrms/attendance/status'] = 'Api_hrms/attendance_status';
...
$route['api/hrms/attendance/out-of-town/check-in'] = 'Api_hrms/attendance_out_of_town_check_in';
...
$route['api/hrms/leave/approvals'] = 'Api_hrms/leave_approvals';
$route['api/hrms/leave/approvals/(:num)'] = 'Api_hrms/leave_approval_detail/$1';
...
$route['api/hrms/overtime/approvals'] = 'Api_hrms/overtime_approvals';
$route['api/hrms/overtime/approvals/(:num)'] = 'Api_hrms/overtime_approval_detail/$1';
...
$route['api/cronjob/threads-token-refresh'] = 'Api_v2/threads_refresh_token';
$route['api_v2/threads_authorize'] = 'Api_v2/threads_authorize';
$route['api_v2/threads_callback'] = 'Api_v2/threads_callback';
$route['api_v2/threads_deauthorize'] = 'Api_v2/threads_deauthorize';
$route['api_v2/threads_delete_data'] = 'Api_v2/threads_delete_data';
$route['api_v2/threads_delete_status'] = 'Api_v2/threads_delete_status';
...
$route['endorse/fetch-optimization-metrics'] = 'Endorse/fetch_optimization_metrics';
$route['endorse/bulk-activate-optimization'] = 'Endorse/bulk_activate_optimization';
...
$route['endorse/queue-diagnostics'] = 'Endorse/queue_diagnostics';
$route['endorse/queue-diagnostics-data'] = 'Endorse/queue_diagnostics_data';
$route['endorse/queue-diagnostics-run'] = 'Endorse/queue_diagnostics_run';
$route['endorse/queue-diagnostics-spike'] = 'Endorse/queue_diagnostics_spike';
$route['endorse/performance-spikes'] = 'Endorse/performance_spikes';
$route['endorse/performance-spikes-data'] = 'Endorse/performance_spikes_data';
$route['endorse/performance-spikes-detail'] = 'Endorse/performance_spikes_detail';
