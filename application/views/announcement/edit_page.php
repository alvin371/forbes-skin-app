<div class="container-fluid py-3">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>announcement/update" method="POST" id="form-announcement">
                <input type="hidden" name="id" value="<?= (int) $data['id'] ?>">
                <?php $this->load->view('announcement/_form_fields', ['data' => $data, 'categories' => $categories, 'statuses' => $statuses, 'priorities' => $priorities]); ?>
                <div class="row mt-4">
                    <div class="col-md-12">
