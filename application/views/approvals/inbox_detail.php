<div class="row">
            ...
            <div class="card-body" style="padding: 16px;">
                ...
                <div class="row" style="margin-bottom: 16px;">
                    <div class="col-6">
                        ...
                        <p style="font-size: 14px; color: rgba(0,0,0,0.85); margin: 0;">
                            <code style="background-color: #f5f5f5; padding: 2px 6px; border-radius: 2px;"><?php echo htmlspecialchars($leave_request['request_no']); ?></code>
                        </p>
                    </div>
                    <div class="col-6">
                        ...
                        <p style="margin: 0;">
                            ...
                            $color = isset($statusColors[$leave_request['status']]) ? $statusColors[$leave_request['status']] : '#d9d9d9';
                            ?>
                ...
                <div class="row" style="margin-bottom: 16px;">
                    <div class="col-4">
                        ...
                        <p style="font-size: 14px; color: rgba(0,0,0,0.85); margin: 0;"><?php echo htmlspecialchars($leave_request['leave_type_name']); ?></p>
                    </div>
                    <div class="col-4">
                        <label style="font-size: 12px; color: rgba(0,0,0,0.45);">Tanggal</label>
                        <p style="font-size: 14px; color: rgba(0,0,0,0.85); margin: 0;">
                            <?php echo date('d M Y', strtotime($leave_request['start_date'])); ?> - <?php echo date('d M Y', strtotime($leave_request['end_date'])); ?>
                        </p>
                    </div>
                    <div class="col-4">
                        ...
                        <p style="font-size: 14px; margin: 0;">
                            <span style="background-color: #e6f7ff; color: #1890ff; padding: 2px 8px; border-radius: 10px; font-size: 14px; font-weight: 500;">
                                <?php echo $leave_request['days_count']; ?> hari
                            </span>
                        </p>
                    </div>
                </div>

                <?php if (!empty($leave_request['reason'])): ?>
                    <div style="margin-bottom: 16px;">
                        ...
                        <p style="font-size: 14px; color: rgba(0,0,0,0.65); margin: 0; padding: 8px; background-color: #fafafa; border-radius: 4px;">
                            <?php echo nl2br(htmlspecialchars($leave_request['reason'])); ?>
                        </p>
                    </div>
                <?php endif; ?>
            ...
            <div class="card" style="border-radius: 2px; border: 1px solid #f0f0f0; box-shadow: 0 2px 8px rgba(0,0,0,0.09);">
                ...
                <div class="card-body" style="padding: 16px;">
                    ...
                    <div style="display: flex; gap: 12px;">
                        <form method="post" action="<?php echo site_url('approvals/inbox/approve/' . $step['id']); ?>" style="flex: 1;" id="approveForm">
                        ...
                        <form method="post" action="<?php echo site_url('approvals/inbox/reject/' . $step['id']); ?>" style="flex: 1;" id="rejectForm" onsubmit="return validateReject();">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
    ...
    <div class="col-md-4">
        ...
        <!-- Back Button -->
        <a href="<?php echo site_url('approvals/inbox'); ?>" class="btn btn-secondary w-100" style="border-radius: 2px;">
