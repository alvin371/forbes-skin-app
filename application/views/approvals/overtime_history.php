    ...
    <div class="card-header" style="background-color: #fff; border-bottom: 1px solid #f0f0f0; padding: 16px; display: flex; align-items: center; justify-content: space-between;">
        <div>
            <h3 style="margin: 0; font-size: 16px; font-weight: 500; color: rgba(0,0,0,0.85);">
                <i class="bi bi-clock-history"></i> Riwayat Approval Lembur
            </h3>
            <small style="color: rgba(0,0,0,0.45);">Pengajuan lembur yang telah Anda tindaklanjuti</small>
        </div>
        <a href="<?php echo site_url('approvals/overtime'); ?>" class="btn btn-outline-primary" style="border-radius: 2px; height: 32px; padding: 4px 15px; font-size: 14px;">
    ...
    <div class="card-body" style="padding: 16px;">
        <?php if (empty($approvals)): ?>
            <div style="text-align: center; padding: 48px 0;">
                ...
                <p style="margin-top: 16px; color: rgba(0,0,0,0.45); font-size: 14px;">Belum ada riwayat approval lembur.</p>
            </div>
        <?php else: ?>
                ...
                <table class="table" style="border: 1px solid #f0f0f0; border-collapse: separate; border-spacing: 0;">
                    <thead>
                        <tr style="background-color: #fafafa;">
                            ...
                            <th style="padding: 12px 8px; border-bottom: 1px solid #f0f0f0; font-weight: 500; color: rgba(0,0,0,0.85); font-size: 14px;">Waktu Tindakan</th>
                        </tr>
                    </thead>
                    <tbody>
