<div class="card" style="border-radius: 2px; border: 1px solid #f0f0f0; box-shadow: 0 2px 8px rgba(0,0,0,0.09);">
    <div class="card-header" style="background-color: #fff; border-bottom: 1px solid #f0f0f0; padding: 16px; display: flex; align-items: center; justify-content: space-between;">
        <div>
            <h3 style="margin: 0; font-size: 16px; font-weight: 500; color: rgba(0,0,0,0.85);">Rute Approval</h3>
            <small style="color: rgba(0,0,0,0.45);">Kelola rute persetujuan HR dari satu halaman sumber utama</small>
        </div>
                            ...
                            <tr style="border-bottom: 1px solid #f0f0f0;">
                                ...
                                <td style="padding: 12px 8px; font-size: 14px;">
                                    <div style="display: flex; gap: 8px;">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo site_url('admin/approval-routes/' . rawurlencode($route['route_code']) . '/versions'); ?>" style="color: #faad14;" title="Riwayat Versi">
