...
final class EndorseApplyCrashConsistencyTest extends TestCase
{
     ...
     */
    public function testCrashRollsBackThenRetryRecovers(string $crashTable): void
    {
        $this->seedQueueRow();
    ...
    public function crashPoints(): array
    {
        return [
            'before endorse update' => ['endorse'],
            'before endorse_logs insert' => ['endorse_logs'],
            'before queue completion' => ['endorse_refresh_queue'],
        ];
    }
